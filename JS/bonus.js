...
function sobreposicaoMicro(microplastico) {
    ...
    microplasticosElements.forEach(function (item) {
        ...
        if (verificaColisaoMicro(item, 21, 20, microplastico, 21, 20)) {
            microplastico.style.left = (mainOffSetLeft + Math.random() * (stageWidth - 21)) + 1 + 'px';
            microplastico.style.top = (mainOffSetTop + Math.random() * (stageHeight - 20)) + 1 + 'px';
